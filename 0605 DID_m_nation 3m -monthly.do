...
logout,save(img3m_m/descriptive_statistics)word replace:tabstat ln_Score ln_pure_string_len pure_body_smog_index full_code_string_ratio tt ln_TotalComment ln_AnswerComment ln_QuestionerComment ln_ViewerComment ln_Q_Tags_len_filter std_Q_Tags_len_filter median_Q_Tags_len_filter $control_fe,s(N mean sd min max) f(%12.3f) c(s)


wmtcorr ln_Score ln_pure_string_len pure_body_smog_index full_code_string_ratio tt ln_TotalComment ln_AnswerComment ln_QuestionerComment ln_ViewerComment ln_Q_Tags_len_filter std_Q_Tags_len_filter median_Q_Tags_len_filter $control_fe using img3m_m/correlationship.rtf, replace
...
cap erase "img3m_m/ln_pure_string_len simulations.dta"
permute did beta = _b[did] se= _se[did] df = e(df_r), reps(500) rseed(42) saving("img3m_m/ln_pure_string_len simulations.dta"):reghdfe ln_pure_string_len did, a(country_id month_nb nation) vce(cluster country_id)


reghdfe pure_body_smog_index did , a(country_id month_nb nation) vce(cluster country_id)
cap erase "img3m_m/pure_body_smog_index simulations.dta"
permute did beta = _b[did] se= _se[did] df = e(df_r), reps(500) rseed(42) saving("img3m_m/pure_body_smog_index simulations.dta"):reghdfe pure_body_smog_index did, a(country_id month_nb nation) vce(cluster country_id)

reghdfe full_code_string_ratio did , a(country_id month_nb nation) vce(cluster country_id)
cap erase "img3m_m/full_code_string_ratio simulations.dta"
permute did beta = _b[did] se= _se[did] df = e(df_r), reps(500) rseed(42) saving("img3m_m/full_code_string_ratio simulations.dta"):reghdfe full_code_string_ratio did, a(country_id month_nb nation) vce(cluster country_id)
