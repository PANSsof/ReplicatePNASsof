...
logout,save(img3m/descriptive_statistics)word replace:tabstat ln_Score ln_pure_string_len pure_body_smog_index full_code_string_ratio tt ln_TotalComment ln_AnswerComment ln_QuestionerComment ln_ViewerComment Q_Tags_len_filter std_Q_Tags_len_filter median_Q_Tags_len_filter $control_fe,s(N mean sd min max) f(%12.3f) c(s)
// swilk ln_body_string_len
// qnorm full_code_string_ratio

wmtcorr ln_Score ln_pure_string_len pure_body_smog_index full_code_string_ratio tt ln_TotalComment ln_AnswerComment ln_QuestionerComment ln_ViewerComment Q_Tags_len_filter std_Q_Tags_len_filter median_Q_Tags_len_filter $control_fe using img3m/correlationship.rtf, replace
